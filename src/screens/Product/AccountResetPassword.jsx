...
const AccountResetPassword = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <Text style={styles.title}>Password Changes</Text>
      ...
      <View style={styles.inputContainer}>
        ...
        />
        <TouchableOpacity onPress={() => setConfirmSecureTextEntry(!confirmSecureTextEntry)} style={styles.eyeIcon}>
          <FontAwesomeIcon icon={confirmSecureTextEntry ? faEyeSlash : faEye} size={20} />
        </TouchableOpacity>
      </View>
