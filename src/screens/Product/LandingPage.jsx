...
import { faSearch, faShoppingCart, faHome, faHeart, faUser, faMusic, faBasketballBall, faMicrophone, faVolleyballBall } from '@fortawesome/free-solid-svg-icons';
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.banner}>
          ...
          <Text style={styles.bannerSubtitle}>Welcome to our Ultimate Destination for Gently Used Sporting Excellence - Where the Game Never Ends, and the Savings Are Endless!</Text>
        </View>

        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.brandContainer}>
          {brands.map((brand, index) => (
            <Image key={index} source={{ uri: `/placeholder.svg?height=50&width=50&text=${brand}` }} style={styles.brandLogo} />
          ))}
        </ScrollView>
